...
const SalesPage = () => {
  ...
  const examples = [
    {
      icon: Heart,
      title: t('sales.examples.family.title'),
      description: t('sales.examples.family.description')
    },
    {
      icon: Trophy,
      title: t('sales.examples.athletes.title'),
      description: t('sales.examples.athletes.description')
    },
    {
      icon: Building2,
      title: t('sales.examples.company.title'),
      description: t('sales.examples.company.description')
    },
    {
      icon: Sparkles,
      title: t('sales.examples.spiritual.title'),
      description: t('sales.examples.spiritual.description')
    }
  ];
            ...
            <div className="relative">
              ...
              <Card className="relative bg-card/80 backdrop-blur-sm border-primary/30">
                <CardContent className="p-8">
                  <Brain className="w-16 h-16 text-primary mx-auto mb-6 animate-neon-pulse-purple" />
